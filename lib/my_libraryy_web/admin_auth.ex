defmodule MyLibraryyWeb.AdminAuth do
  use MyLibraryyWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_my_libraryy_web_admin_remember_me"
  ...
  def log_out_admin(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      MyLibraryyWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_admin:
      ...
      defmodule MyLibraryyWeb.PageLive do
        use MyLibraryyWeb, :live_view

        on_mount {MyLibraryyWeb.AdminAuth, :mount_current_admin}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{MyLibraryyWeb.AdminAuth, :ensure_authenticated}] do
