defmodule MyLibraryyWeb.LoanLiveTest do
  use MyLibraryyWeb.ConnCase

  import Phoenix.LiveViewTest
  import MyLibraryy.LibraryFixtures

  @create_attrs %{borrowed_at: "2025-07-21", due_at: "2025-07-21", returned_at: "2025-07-21"}
  @update_attrs %{borrowed_at: "2025-07-22", due_at: "2025-07-22", returned_at: "2025-07-22"}
