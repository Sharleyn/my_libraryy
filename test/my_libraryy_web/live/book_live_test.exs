defmodule MyLibraryyWeb.BookLiveTest do
  use MyLibraryyWeb.ConnCase

  import Phoenix.LiveViewTest
  import MyLibraryy.LibraryFixtures

  @create_attrs %{title: "some title", author: "some author", isbn: "some isbn", published_at: "2025-07-21"}
  @update_attrs %{title: "some updated title", author: "some updated author", isbn: "some updated isbn", published_at: "2025-07-22"}
